function MCHP_pic32_stf_select_callback(varargin)
% MCHP_pic32_stf_select_callback callback handler for dspic real-time options
...
h = waitbar(0,'Set-up Simulink parameters for pic32');
