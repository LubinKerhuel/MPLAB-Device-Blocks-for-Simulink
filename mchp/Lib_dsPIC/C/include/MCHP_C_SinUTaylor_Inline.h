#ifndef C_SINU_TAYLOR_H
#define C_SINU_TAYLOR_H

#include <xc.h>

static inline __attribute__((always_inline)) unsigned int MCHP_C_SinUTaylor_Inline(unsigned int u1,unsigned int u2,unsigned int u3) 
{
    union a{
        unsigned int  u;
        signed int    s;
