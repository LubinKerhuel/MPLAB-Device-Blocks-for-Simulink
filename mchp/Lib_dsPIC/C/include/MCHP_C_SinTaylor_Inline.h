#ifndef C_SIN_TAYLOR_H
#define C_SIN_TAYLOR_H

#include <xc.h>
	
static inline  __attribute__((always_inline)) unsigned int MCHP_C_SinTaylor_Inline(signed int u1,unsigned int u2,unsigned int u3) 
{
    union a{
        unsigned int  u;
        signed int    s;
